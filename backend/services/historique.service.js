// // services/historique.service.js
...
//   /**
//    * Formater un identifiant lisible pour un élément
//    */
...
//     // Tentative de trouver un champ pertinent
...
//   /**
//    * Obtenir la liste des changements entre deux objets
//    */
//   static getChanges(oldObj, newObj) {
//     if (!oldObj || !newObj) return "Données non disponibles";
...
//     const identifier = this.formatIdentifier(newItem, identifierField);
...
//     const identifier = this.formatIdentifier(deletedItem, identifierField);
